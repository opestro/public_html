...
@media (max-width: 1200px) {
    html[dir="rtl"] aside {
      transform: translateX(100%); /* Move the aside off the screen */
    }
}    
</style>
<div id="sidebarMain" class="d-none">
    ...
    <aside
       ...
       class="custom-background js-navbar-vertical-aside navbar navbar-vertical-aside navbar-vertical navbar-vertical-fixed navbar-expand-xl navbar-bordered">
        
        <button type="button" style="display : none;" class="js-navbar-vertical-aside-toggle-invoker close" id="toggleButton">
                                <div class="icon-ball-mobile navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                                    data-placement="right" title="Collapse">&lt;</div>
                                <div class="icon-ball-mobile navbar-vertical-aside-toggle-full-align"
                                    data-template='<div class="tooltip d-none d-sm-block" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>'
                                    data-toggle="tooltip" data-placement="right" title="Expand">&gt;</div>
                    </button>
            ...
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo ">
                    ...
                    <div class="media-body">
                        <span class="card-title user-name h5">{{auth('admin')->user()->name}}</span>
                        <span class="card-text user-email">{{auth('admin')->user()->email}}</span>
                    </div>
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        <!-- Dashboards -->
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/dashboard')?'active':''}} Dashboard">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/sellers/seller-add')?'active':''}}">
                                 ...
                                 <li class="nav-item {{Request::is('admin/sellers/seller-list')?'active':''}}">
                                  ...
                                  <li class="nav-item {{Request::is('admin/sellers/active-sellers')?'active':''}}">
                                    <a class="nav-link" title="{{\App\CPU\translate('Active_Sellers')}}"
                                       href="{{route('admin.sellers.active-sellers')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                        {{\App\CPU\translate('Approved_Sellers_List')}}
                                    </span>
                                    </a>
                                </li>
                        ...
                        <!--System Settings end-->
                         ...
                         <li class="navbar-vertical-aside-has-menu" id="logoutButton">
