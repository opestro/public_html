        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    ...
                    <li class="nav-item d-none d-md-inline-block languages">
                        <div class="hs-unfold">
                            <div>
                    ...
                    <li class="nav-item d-none d-md-inline-block website">
                        <div class="hs-unfold">
                    ...
                    @if(\App\CPU\Helpers::module_permission_check('support_section'))
                        <li class="nav-item d-none d-md-inline-block Messages">
                            <!-- Notification -->
                            <div class="hs-unfold">
                    ...
                    @if(\App\CPU\Helpers::module_permission_check('order_management'))
                        <li class="nav-item d-none d-md-inline-block orders">
                            <!-- Notification -->
                            <div class="hs-unfold">
                                <a class="js-hs-unfold-invoker btn btn-icon btn-ghost-secondary rounded-circle"
