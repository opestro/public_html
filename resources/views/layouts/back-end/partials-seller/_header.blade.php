        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-left">
                ...
                <button type="button" class="js-navbar-vertical-aside-toggle-invoker close mr-3 d-xl-none">
                    <div class="icon-ball navbar-vertical-aside-toggle-short-align" data-toggle="tooltip"
                       data-placement="right" title="Collapse">&lt;</div>
                    <div class="icon-ball navbar-vertical-aside-toggle-full-align"
            ...
            <div class="navbar-nav-wrap-content-right"
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    ...
                    <li class="nav-item">
                        <!-- Account -->
                        <div class="hs-unfold">
                            <a id="settings-dropdown-button" class="js-hs-unfold-invoker media align-items-center gap-3 navbar-dropdown-account-wrapper dropdown-toggle dropdown-toggle-left-arrow" href="javascript:;"
                               data-hs-unfold-options='{
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <div class="dropdown-divider"></div>
                                <div>
                                <a id="settings-button" class="dropdown-item"
