...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\translate('Delete_account')}}</title>
    ...
    <div class="container py-5 py-sm-7">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <h2 class="h3 mb-4">{{\App\CPU\translate('Delete_account?')}}</h2>
                @if(session('error'))
                ...
                <ol class="list-unstyled font-size-md">
                    ...
                    <li><span class="text-primary mr-2">2.</span>{{\App\CPU\translate('If your email is correct we will get request and delete your account and all your data')}}.
                    </li>
                </ol>
                    <div class="card py-2 mt-4">
                        <form class="card-body needs-validation" action="{{route('delete-account')}}"
                            method="post">
                            @csrf
                            <div class="form-group">
                                <label for="email-delete-account">{{\App\CPU\translate('Enter your email address')}}</label>
                                <input class="form-control" type="email" name="identity" id="email-delete-account" required>
                                <div class="invalid-feedback">{{\App\CPU\translate('Please provide valid email address')}}.</div>
                            </div>
                            <button class="btn btn-primary" type="submit">{{\App\CPU\translate('Delete_account')}}</button>
                        </form>
                    </div>
