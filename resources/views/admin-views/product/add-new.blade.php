...
<p>
                                                                ...
                                                                <a href="https://squoosh.app/" target="_blank" style="font-size: smaller;">{{ \App\CPU\translate('Squoosh') }}</a>
                                                                {{ \App\CPU\translate('to compress your images') }}
                                                            </p>
                                        ...
                                        <div class="col-md-4 form-group">
                                            <div class="mb-2">
                                                ...
                                                <span class="text-info">* ( {{ \App\CPU\translate('ratio') }} 1:1 )</span>
  <p>
                                                                {{ \App\CPU\translate('A_thumbnail_image_acts_as_a_preview') }}
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                var formData = new FormData(document.getElementById('product_form'));
                 var cobaImages = formData.getAll('images[]');
                console.log('Original cobaImages:', cobaImages);
                
                var thumbnailImage = formData.get('image');
                console.log(`Name: ${thumbnailImage.name}, Type: ${thumbnailImage.type}, Size: ${thumbnailImage.size} bytes`);
                
                var meta_image = formData.get('meta_image');
                console.log('Original meta_image:', meta_image);
                
                // Iterate and log details
                cobaImages.forEach((image, index) => {
                    console.log(`Image ${index + 1} - Name: ${image.name}, Type: ${image.type}, Size: ${image.size} bytes`);
                });
                ...
                $.post({
                    ...
                    processData: false,
                    success: function (data) {
                        // Hide loading logo once the request is complete
