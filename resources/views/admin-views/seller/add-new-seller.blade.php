            ...
            <div class="card-body">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <input type="number" class="form-control form-control-user" id="exampleInputPhone" name="phone"  maxlength="10" minlength="10" size="10" value="0{{old('phone')}}" placeholder="{{\App\CPU\translate('phone_number')}}" 
                ...
                <div class="row">
                   ...
                   <div class="col-lg-6 form-group">
                       <select name="shop_address" class="form-control" id="shop_address" required>
                        <option value="" disabled selected>{{\App\CPU\translate('Select Membership Offer')}}</option>
                        <option value="Basic Store (MONTHLY) 1000DA">{{\App\CPU\translate('Basic Store (MONTHLY) 1000DA')}}</option>
                        <option value="Standard Store (MONTHLY) 2490DA">{{\App\CPU\translate('Standard Store (MONTHLY) 2490DA')}}</option>
                        <option value="Pro Store (MONTHLY) 3490DA">{{\App\CPU\translate('Pro Store (MONTHLY) 3490DA')}}</option>
                     </select>
