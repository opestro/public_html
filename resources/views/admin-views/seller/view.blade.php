                ...
                @if ($seller->status=="pending")
                    <div class="mt-4 pr-2 float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                        ...
                        <div class="text-center">
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus2')}}" method="POST">
                                @csrf
                    ...
                    <div class="card-header text-capitalize">
                        ...
                        @if($seller->status=='approved')
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus2')}}" method="POST">
                                ...
                                <input type="hidden" name="status" value="suspended">
                                <button type="submit"
                                        class="btn btn-sm btn-outline-danger">{{\App\CPU\translate('suspend_with_update')}}</button>
                            </form>
                        @elseif($seller->status=='rejected' || $seller->status=='suspended')
                            <form class="d-inline-block" action="{{route('admin.sellers.updateStatus2')}}" method="POST">
                                @csrf
                                ...
                                <input type="hidden" name="status" value="approved">
                                <button type="submit"
                                        class="btn btn-outline-success">{{\App\CPU\translate('activate_with_update')}}</button>
                            </form>
                        @endif
                    </div>
                    <div class="card-body"
                ...
                <div class="col-md-6 mt-2 mt-md-0">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form class="d-inline-block" action="{{ route('admin.sellers.viewInfo', $seller->id) }}" method="GET">
                                <button type="submit"
                                        class="btn btn-sm btn-outline-danger">{{\App\CPU\translate('edit')}}</button>
                            </form>
                        </div>
                        ...
                        <div class="card-body"
                            ...
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('Membership')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->address}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('MembershipPrice')}} : </h5></div>
                                <div class="mx-1"><h5>{{$membershipPrice}} {{\App\CPU\translate('DA')}}</h5></div>
                            </div>
                             <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('Duration')}} : </h5></div>
                                <div class="mx-1"><h5>{{$seller->shop->duration}} {{\App\CPU\translate('months')}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('Total_payment')}} : </h5></div>
                                <div class="mx-1"><h5>{{$totalAmount}} {{\App\CPU\translate('DA')}}</h5></div>
                            </div>
                            <div class="flex-start">
                                <div><h5>{{\App\CPU\translate('_subscription_end_date')}} : </h5></div>
                                <div class="mx-1"><h5>{{$subscriptionEnd}}</h5></div>
                            </div>
                        </div>
                    </div>
                </div>
