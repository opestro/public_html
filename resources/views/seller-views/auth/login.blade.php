                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <form id="form-id"  action="{{route('seller.auth.login')}}" method="post">
                                ...
                                <label class="input-label" for="signupSrPassword" tabindex="0">
                                    <span class="d-flex justify-content-between align-items-center">
                                      {{\App\CPU\translate('password')}}
                                            <a href="{{route('seller.auth.forgot-password')}}" style="color: #FF4D00;">
                            ...
                            <button type="submit" class="btn btn-lg btn-block" style="background-color: #FF4D00; color: white;" >{{\App\CPU\translate('sign_in')}}</button>
                        </form>
                        <!-- End Form -->
                    </div>
...
<script>
    ...
    const messaging = firebase.messaging();
        messaging.getToken().then((currentToken) => {
            // Add a hidden input field to the form with the FCM token
