...
.card-header {
            background-color: #f26c05; /* Example header background color */
            color: #fff; /* Example header text color */
}

.card-title {
            font-size: 1.2rem; /* Example title font size */
            color: white;
}
.card-body {
            padding: 20px;
...
<div class="container-registration py-5 rtl" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">

    <h3 class="shop-header"> {{translate('Shop')}} {{translate('Application')}}</h3>
    <form class="__shop-apply" action="{{route('shop.apply')}}" id="form-id" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card __card mb-3" style="outline: 1px solid #CCCCCC; box-shadow: 5px 5px 10px grey;">
                        ...
                        <g>
                            <g>
                                <path d="M239.7,260.2c0.5,0,1,0,1.6,0c0.2,0,0.4,0,0.6,0c0.3,0,0.7,0,1,0c29.3-0.5,53-10.8,70.5-30.5
                                    ...
                                    c-22-0.2-38.9-7.2-51.4-21.4C157.7,176.2,164.5,107.9,164.6,107.3z" fill="#FFFFFF" data-original="#FFFFFF" class=""></path>
                                <path d="M446.8,383.6c0-0.1,0-0.2,0-0.3c0-0.8-0.1-1.6-0.1-2.5c-0.6-19.8-1.9-66.1-45.3-80.9c-0.3-0.1-0.7-0.2-1-0.3
                                    ...
                                    C447,415.5,446.9,388.8,446.8,383.6z" fill="#FFFFFF" data-original="#FFFFFF" class=""></path>
                            </g>
                        </g>
                    </svg>
            ...
            <div class="card-body" style="outline: 1px solid #CCCCCC; box-shadow: 5px 5px 10px grey;">
                <div class="row g-3">
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user custom-outline" id="exampleFirstName" name="f_name" value="{{old('f_name')}}" placeholder="{{\App\CPU\translate('first_name / prénoms')}}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user custom-outline" id="exampleLastName" name="l_name" value="{{old('l_name')}}" placeholder="{{\App\CPU\translate('last_name / Nom')}}" required>
                    </div>
                    <div class="col-sm-6 mt-4">
                        <input type="email" class="form-control form-control-user custom-outline" id="exampleInputEmail" name="email" value="{{old('email')}}" placeholder="{{\App\CPU\translate('email_address')}}" required>
                    </div>
                    <div class="col-sm-6"><small class="text-danger">(  {{\App\CPU\translate('')}} {{\App\CPU\translate('0xxxxxxxxx')}} )</small>
                        <input  class="form-control form-control-user custom-outline" id="exampleInputPhone" name="phone" type="tel" pattern="0\d{9}" maxlength="10" minlength="10" size="10" value="0{{old('phone')}}" placeholder="{{\App\CPU\translate('phone_number / Numero de telephone')}}" 
                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="password" class="form-control form-control-user custom-outline" minlength="6" id="exampleInputPassword" name="password" placeholder="{{\App\CPU\translate('password / mot de passe')}}" required>
                    </div>
                    <div class="col-sm-6">
                        <input type="password" class="form-control form-control-user custom-outline" minlength="6" id="exampleRepeatPassword" placeholder="{{\App\CPU\translate('repeat_password / Confirmer Mot de passe')}}" required>
                    ...
                    <div class="col-sm-12">
                        <center>
                            <img class="__img-125px object-cover" id="viewer"
                                src="{{asset('public\assets\back-end\img\400x400\img2.png')}}" alt="Profile picture"/>
                        </center>
                        <div class="custom-file mt-3">
                            <input type="file" name="image" id="customFileUpload" class="custom-file-input custom-outline"
                                accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                            <label class="custom-file-label custom-outline" for="customFileUpload">{{\App\CPU\translate('Upload ')}} {{\App\CPU\translate('Profile Picture ')}}</label>
                        </div>
                    </div>
                </div>
            </div>
         ...
         <div class="card __card mb-3" style="outline: 1px solid #CCCCCC; box-shadow: 5px 5px 10px grey;" >
            <div class="card-header">
                <h5 class="card-title m-0">
                    ...
                    {{\App\CPU\translate('Membership')}} {{\App\CPU\translate('offers / abonnements')}}
                </h5>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <!-- Add one large image element within the same row -->
                    <div class="col-sm-12">
                        ...
                        <div class="pb-3">
                            <center>
                                <img class="__img-125px object-cover" id="viewerLogo"
                                    src="{{asset('public\assets\back-end\img\400x400\imgshop.png')}}" alt="Logo magasin"/>
                            </center>
                        </div>

                        <div class="form-group mb-0">
                            <div class="custom-file">
                                <input type="file" name="logo" id="LogoUpload" class="custom-file-input custom-outline"
                                    accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label custom-outline" for="LogoUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('logo du Magasin')}}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="pb-3">
                            <center>
                                <img class="__img-125px object-cover" id="viewerBanner"
                                        src="{{asset('public\assets\back-end\img\400x400\imgbanner.png')}}" alt="banner image"/>
                            </center>
                        </div>

                        <div class="form-group">
                            <div class="custom-file">
                                <input type="file" name="banner" id="BannerUpload" class="custom-file-input overflow-hidden __p-2p custom-outline" accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label custom-outline" for="BannerUpload">{{\App\CPU\translate('Upload')}} {{\App\CPU\translate('Banner du magasin')}}</label>
                            </div>
                        </div>
                    </div>
                    {{-- recaptcha --}}
                    ...
                    <div class="col-12">
                        <div class="row py-2">
                            <div class="col-6 pr-0">
                                <input type="text" class="form-control __h-40 custom-outline" name="default_recaptcha_id_seller_regi" value=""
