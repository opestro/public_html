                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 mb-3">
                                    <div class="text-info mb-2">( * {{\App\CPU\translate('')}} {{\App\CPU\translate('0xxxxxxxxxx')}} )</div>
                                    <input type="tel" pattern="d{10}" maxlength="10" minlength="10" size="10" class="js-masked-input form-control" name="phone" id="phoneLabel"
                                           placeholder="0xxxxxxxxx" aria-label="0xxxxxxxxx"
                                           value="{{$data->phone}}"
