...
@push('css_or_js')
    ...
    /* Add animation to the loading logo */
    @keyframes spin {
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="{{ route('seller.product.add-new') }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row align-items-end">
                                    ...
                                    <div class="hide"  style="display: none;" id="shipping_cost">
                                        <label class="title-color" style="display: none;">{{ \App\CPU\translate('shipping_cost') }} </label>
                                        <input type="number" min="0" value="0" step="1"
                    ...
                    <div class="card mt-2 mb-2 rest-part" style="display: none;">
                        <div class="card-header">
                            <h5 class="card-title">
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-body __coba-aspect">
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-3">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="notice-text">
                                            <small class="text" style="color: red;">{{ \App\CPU\translate('The_upload_speed_depends_on_image_size') }}</small>
                                        </div>
                                    </div>
                                ...
                                <div id="loadingLogo">
                                    <div id="loadingMessage">{{ \App\CPU\translate('Uploading')}}</div>
                                    <div>{{ \App\CPU\translate('The_upload_speed_depends_on_image_size')}}</div>
                                </div>
                            ...
                            <div class="hide" style="display: none;">
                                        <label for="name" class="title-color" style="display: none;">{{ \App\CPU\translate('Unit') }}</label>
                                        <select class="js-example-basic-multiple form-control" name="unit" style="display: none;">
                            ...
                            <div class="hide" style="display: none;">
                                        ...
                                        <div class="hide" id="minimum_order_qty" style="display: none;">
...
@push('script')
    ...
    <script>
        ...
        if (!$('input[name="colors_active"]').is(':checked')) {
            $('#colors-selector').closest('.form-group').hide();
            $('#choice_attributes').closest('.form-group').hide();
        }
    });
        $('input[name="colors_active"]').on('change', function () {
            if (!$(this).is(':checked')) {
                ...
                $('#colors-selector').closest('.form-group').show();
                $('#choice_attributes').closest('.form-group').show();
            }
        });
