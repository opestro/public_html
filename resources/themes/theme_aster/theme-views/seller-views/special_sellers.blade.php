...
@section('title', $web_config['name']->value.' '.translate('Special_Stores').' | '.$web_config['name']->value.' '.translate(' Ecommerce'))
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row gy-2 align-items-center">
                        <div class="col-md-8">
                            <h3 class="mb-1">{{translate('Special_Stores')}}</h3>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb fs-12 mb-0">
                                  <li class="breadcrumb-item"><a href="{{route('home')}}">{{translate('home')}}</a></li>
                                  <li class="breadcrumb-item active" aria-current="page">
                                   <a href="{{route('special-sellers')}}">{{translate('stores')}}</a></li>
                                </ol>
                              </nav>
                        </div>
                        <div class="col-md-4">
                            <div class="custom_search position-relative float-end">
                                <form action="{{route('search-special-shop')}}">
                                @csrf
                                <div class="d-flex">
