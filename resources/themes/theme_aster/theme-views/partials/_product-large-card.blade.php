...
<div class="product border rounded text-center d-flex flex-column gap-10 ov-hidden cursor-pointer"
    ...
    <div class="product__top" style="--width: 100%;">
        ...
        <div class="product__thumbnail" style="width: 100%;">
    ...
    <!-- Product Summery -->
    <div class="product__summary d-flex flex-column align-items-center gap-1 pb-3 cursor-pointer" style="width: 100%;">
