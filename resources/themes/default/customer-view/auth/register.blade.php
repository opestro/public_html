                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="reg-phone">{{\App\CPU\translate('phone_number')}}
                                            <small class="text-primary">( * {{\App\CPU\translate(' ')}} {{\App\CPU\translate('0xxxxxxxxx')}} )</small></label>
                                        <input class="form-control"  type="tel" pattern="0\d{9}" maxlength="10" minlength="10" size="10" value="0{{old('phone')}}"  name="phone"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"  oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                               required>
                                        <div class="invalid-feedback">{{\App\CPU\translate('Please enter a valid 10-digit phone number')}}!</div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
