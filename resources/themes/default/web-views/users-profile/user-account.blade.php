                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 mb-0">
                                            ...
                                            <small class="text-primary">(
                                                * {{\App\CPU\translate('')}} {{\App\CPU\translate('0xxxxxxxxx')}}
                                                )</small></label>
                                            <input type="number" class="form-control" type="text" id="phone"
                                                   name="phone"
                                                    maxlength="10" minlength="10" size="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
