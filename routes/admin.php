...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'notification', 'as' => 'notification.','middleware'=>['module:promotion_management']], function () {
            ...
            Route::get('index-2', 'NotificationController@index_2')->name('index-2');
        ...
        Route::group(['prefix' => 'sellers', 'as' => 'sellers.','middleware'=>['module:user_section']], function () {
            ...
            Route::get('active-sellers', 'SellerController@active_sellers')->name('active-sellers');
            ...
            Route::get('send-warnings', 'SellerController@send_warnings')->name('send-warnings');
            ...
            Route::post('update-status2', 'SellerController@updateStatus2')->name('updateStatus2');
            ...
            Route::get('viewInfo/{id}', 'SellerController@viewInfo')->name('viewInfo');
            Route::post('updateInfo', 'SellerController@updateInfo')->name('updateInfo');
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.'], function () {
            ...
            Route::group(['middleware'=>['module:system_settings']],function (){
                ...
                Route::get('statistics-setup', 'BusinessSettingsController@statistics_setup')->name('statistics-setup');
                Route::post('statistics-setup-update', 'BusinessSettingsController@statistics_setup_update')->name('statistics-setup-update');
            });
